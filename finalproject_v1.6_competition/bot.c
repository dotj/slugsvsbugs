...
#define BEACON_DETECTOR_01_TRIS PORTZ03_TRIS // PORTZ03_BIT
#define BEACON_DETECTOR_01      PORTZ03_BIT // PORTZ03_BIT
#define BEACON_DETECTOR_02_TRIS PORTV07_TRIS // PORTV07_BIT
#define BEACON_DETECTOR_02      PORTV07_BIT // PORTV07_BIT
#define BEACON_DETECTOR_03_TRIS PORTV08_TRIS // PORTV08_BIT
#define BEACON_DETECTOR_03      PORTV08_BIT // PORTV08_BIT
...
void Bot_Init(void) {
    ...
    BEACON_DETECTOR_01_TRIS = 1; // 1: set as input
    BEACON_DETECTOR_02_TRIS = 1; // 1: set as input
    BEACON_DETECTOR_03_TRIS = 1; // 1: set as input
...
char Bot_CheckBeacon(void) {
    ...
    return !BEACON_DETECTOR_02;
}
char Bot_CheckRBeacon(void) {

    return !BEACON_DETECTOR_03;
}
char Bot_CheckLBeacon(void) {

    return !BEACON_DETECTOR_01;
}
...
char Bot_Turret_Position(unsigned short int newposition) {
    if (RC_SetPulseTime(TURRET_RC, newposition) == ERROR) {
        printf("ERROR: setting turret position!\n");
